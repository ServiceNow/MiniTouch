...
class HapticsExplorationMulti(PandaHaptics):

    def __init__(self, min_num_cube=1, max_num_cube=5, min_scale=0.5, max_scale=1, min_mass=5, max_mass=50,
                 randomize_color=True, max_z=0.1, randomize_cube_pos=True, **kwargs):

        super(HapticsExplorationMulti, self).__init__(**kwargs)
    ...
    def place_objects(self):
        ...
        for i in range(0, num_objects):
            ...
            self.objectUid = p.loadURDF(self.object_file_path, basePosition=new_cube_pos,
